...
wget https://github.com/tonebiclas/xui.one/raw/refs/heads/master/install-dep.sh -qO /tmp/install-dep.sh >/dev/null 2>&1
bash /tmp/install-dep.sh
cd /root
wget https://github.com/tonebiclas/xui.one/releases/download/test/XUI_1.5.13.zip -qO XUI_1.5.13.zip >/dev/null 2>&1
